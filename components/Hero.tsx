  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-32 left-1/2 -translate-x-1/2 z-10 flex items-center gap-4">
        <span className="block w-12 h-[1px] bg-[#FF5E3A]"></span>
        <span className="text-[#FF5E3A] text-[10px] uppercase tracking-[0.4em] font-bold">Depuis Beaumont</span>
        <span className="block w-12 h-[1px] bg-[#FF5E3A]"></span>
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <h1 className="text-white text-5xl md:text-7xl lg:text-9xl font-bold leading-[0.9] mb-8 uppercase tracking-tight">
          Pizzeria
          <span className="block text-[#FF5E3A]">à Beaumont</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
          <a href="tel:071327874" className="group bg-[#FF5E3A] text-white px-10 py-4 font-bold hover:bg-[#e04d2b] transition-all transform hover:-translate-y-1 shadow-2xl flex items-center justify-center gap-3 uppercase text-xs tracking-[0.2em]">
